      ...
      <div className="col2">
        <div className="grid2">
          <ul
            ...
            role="menu"
            style={{ listStyle: "none", padding: 0, display: "contents" }}
          >
            <li role="menuitem" className="col11">
              <a href="https://www.csus.edu/apply/index.html">APPLY</a>
            </li>
            <li role="menuitem" className="col12">
              <a href="https://www.csus.edu/experience/index.html">
                EXPERIENCE
              </a>
            </li>
            <li role="menuitem" className="col13">
              <a href="https://www.csus.edu/giving">GIVE</a>
            </li>
          </ul>
          {/* Menu Button */}
          <img
